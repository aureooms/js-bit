...
const likelyhasbetween = ( x , m , n ) => ( ( ( (x) - ( (~0 >>> 0 ) / 255 )*(n))&~(x)&((x)&( (~0 >>> 0 ) / 255 )*127)+( (~0 >>> 0 ) / 255 )*(127-(m)))&( (~0 >>> 0 ) / 255 )*128) ;

const hasbetween = ( x , m , n ) =>
((( (~0 >>> 0 ) / 255 )*(127+(n))-((x)&( (~0 >>> 0 ) / 255 )*127)&~(x)&((x)&( (~0 >>> 0 ) / 255 )*127)+( (~0 >>> 0 ) / 255 )*(127-(m)))&( (~0 >>> 0 ) / 255 )*128) ;

const countbetween = ( x , m , n ) => ( hasbetween( x , m , n ) >>> 7 ) % 255 ;
